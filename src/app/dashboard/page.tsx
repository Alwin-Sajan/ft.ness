...
const DarshboardPage = () => {
    return (
        <div className="relative mx-auto mt-10 flex max-w-7xl flex-col items-center ">
            <Navbar />
            <h1 className="text-3xl py-16">Dashboard</h1>
            <div className="flex">
                <div className="bg-neutral-700 aspect-[16/9] h-[60vh]">
    ...
    return (
        <nav className="flex w-full items-center justify-between border-t border-b border-neutral-200 px-4 py-4 dark:border-neutral-800">
            ...
            <div>
                ...
                <Link href="/login" className="w-24 transform rounded-lg bg-black px-6 py-2 text-center font-medium text-white transition-all duration-300 hover:-translate-y-0.5 hover:bg-gray-800 md:w-32 dark:bg-white dark:text-black dark:hover:bg-gray-200">settings
                </Link>
            </div>
        </nav>
    );
